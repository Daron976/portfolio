...
let mobileWorkHeader = document.querySelectorAll('.mobile_work_header');
mobileWorkHeader.textContent = popUpContent[1].mobileTitle;
let desktopWorkHeader = document.querySelectorAll('.desktop_work_header');
desktopWorkHeader.textContent = popUpContent[1].desktopTitle;
let workImg = document.querySelectorAll('.card');
let supportingTextHeader = document.querySelectorAll('.supporting_text > h3');
let workInfo = document.querySelectorAll('.work_info');
let workBtn = document.querySelectorAll('.supporting_text > button');
for (let i = 0; i < 4; i++) {
  workImg[i].setAttribute('src', popUpContent[1].featuredImage);
...
let projectOne = document.querySelectorAll('.projectOne > li');
let projectTwo = document.querySelectorAll('.projectTwo > li');
let projectThree = document.querySelectorAll('.projectThree > li');
let projectFour = document.querySelectorAll('.projectFour > li');
for (let i = 0; i < 4; i++) {
